...
const AboutRocketSection = () => {
  return (
    <>
      {/* mobile */}
      <section className="lg:hidden max-w-[428px] w-full mx-auto py-[36px] px-[24px] bg-[rgba(229,235,255,1)] rounded-[24px]">
        <h3 className="text-neutral-700">About Rocket</h3>
