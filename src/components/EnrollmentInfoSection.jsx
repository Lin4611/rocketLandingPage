...
const EnrollmentInfoSection = () => {
  return (
    <section className="text-Neutral-700 font-[400] ">
      {/* mobile */}
      <div className="lg:hidden">
        <div className="mb-[48px]  pl-[47px] pr-[49px]">
          <h2 className="heading-3 mb-[4px]">培訓費用</h2>
          <div className="py-[20px]">
            <div className="flex gap-x-[16px] py-[20px] border-b-2 border-Neutral-200">
      ...
      <div className="max-lg:hidden">
        <div className="mb-[48px] font-[500] pl-[47px] pr-[49px]">
          <h2 className="heading-3 mb-[4px]">培訓費用</h2>
          <div className="py-[20px]">
            <div className="flex gap-x-[16px] p-[20px] border-b-2 border-Neutral-200">
              <div className="shrink-0">
